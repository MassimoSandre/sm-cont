                ...
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="join flex-shrink-0">
                        <button className="btn btn-sm join-item"
                                onClick={() => setTreeData(buildTreeNodes(accountCategories))}>Reset
                        </button>
                        ...
                        <div className="card bg-base-100 shadow-sm">
                            <div className="card-body">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
                                        ...
                                        <div className="form-control col-span-2">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div
                                                    className="text-xs opacity-60 ml-auto">{formIcon.replace('fa-', '')}</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <div
                                        className="text-xs opacity-60">Selected: {selected ? (selected.data as AccountCategory).name : 'Nessuno'}</div>
                                </div>
                            </div>
                        </div>
                    </aside>)}
