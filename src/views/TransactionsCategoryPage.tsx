...
export const TransactionsCategoryPage: React.FC = () => {
  const { transactionCategories, addTransactionCategory, fetchCategories, updateTransactionCategory, deleteTransactionCategory } = useTransactionsCategoryViewModel();
