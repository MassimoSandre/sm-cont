...
type CategoryNode = TransactionCategory & { children?: CategoryNode[] };

function buildTree(categories: TransactionCategory[]): CategoryNode[] {
...
export const TransactionsCategoryPage: React.FC = () => {
  ...
  const openForm = (cat?: TransactionCategory, isChild = false) => {
  ...
  const tree = buildTree(transactionCategories);
  ...
  return (
    <div className="p-4 flex gap-4">
      ...
      <div className="flex-1 max-h-screen overflow-auto">
        ...
        {/* Card speciale per aggiungere nuova categoria di primo livello */}
        <div
