...
(
    ...
    from_account_id INTEGER REFERENCES accounts
(
    id
),
    to_account_id INTEGER REFERENCES accounts
(
    id
),
...
insert into migrations (id, name, date)
values (1, 'initial_setup', datetime('now'));